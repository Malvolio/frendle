...
const AboutMission = () => (
  <div className="min-h-screen max-w-6xl m-auto gap-6">
    ...
    <p>Frendle was created as part of the <a href="https://hackathon.dev/" target="_blank" title="Learn more about Bolt.New Hackaton" className="underline-offset-4 underline decoration-wavy font-bold">Bolt.New Hackaton</a>, what came to be the world's largest hackaton. It's been a long month but with the help of Ai, we've taken the opportunity to work togehter on something special. We hope you take a peak around and share your feedback as we look beyond the hackathon to bring Frendle to life.</p>
