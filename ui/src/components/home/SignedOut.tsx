    ...
    <PublicLayout>
      <section className="relative min-h-screen">
        ...
        <motion.section
          ...
          className="h-auto  bg-[#FFFDFA]/70 bg-fixed bg-no-repeat"
          style={{
            margin: "0 auto",
            padding: "0",
            zIndex: 10,
            ...
            <>
              ...
              >
                ...
                <p className="text-lg md:text-1xl mb-8 animate-fade-in font-normal text-[#37251E] text-center mx-auto pb-4 mt-2 max-w-5xl">
                  ...
                  that bring people closer together. Frendle is about matching
                  you with kind, curious humans for meaningful, platonic chats.
                </p>
              </RoughNotation>
            </>
          </div>
