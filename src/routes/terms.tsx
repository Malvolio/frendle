      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-8 text-foreground/60">
            <p>
              Last updated: <span className="font-semibold">December 2024</span>
            </p>
          </div>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              agree to abide by the above, please do not use this service. These
          ...
          <section className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              of information in accordance with our Privacy Policy. We are
          ...
          <section className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              of the courts in that state or location. Any disputes arising
              under these terms shall be resolved through binding arbitration.
            </p>
          </section>
