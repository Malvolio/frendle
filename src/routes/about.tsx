        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              ...
              social isolation and build meaningful connections in our
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We believe in fostering genuine human connections. Our
                    guided activities are designed to help people move beyond
                    small talk and form meaningful relationships.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    committed to creating spaces where everyone can feel
                    connected, heard, and valued.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    We're committed to social impact. Our transparent donation
                    model lets users select a 501(c) charity, and we take no
                    fees from these donations.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-muted/40 rounded-lg p-8 md:p-12 max-w-5xl mx-auto mb-20">
            <div className="text-center mb-10">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                We believe in putting social impact at the center of our
                business model.
              </p>
            </div>
          ...
          <div className="bg-primary/5 rounded-lg p-10 text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Be part of a growing community of people dedicated to fostering
              meaningful connections and reducing social isolation.
            </p>
