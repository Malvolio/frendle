...
import { Video, Clock, Users, MessageSquare } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <p className="text-lg text-muted-foreground">
            Connect with strangers through brief, guided activities in a safe environment.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                You'll be matched with someone who shares your interests for a brief video chat.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-muted/50 rounded-lg p-4 flex flex-col items-center text-center">
                    ...
                    <div className="text-sm text-muted-foreground">private conversation</div>
                  </div>
                ...
                <div className="pt-4">
                  ...
                  <p className="text-sm text-muted-foreground mt-4">
                    Note: This feature is coming soon! Check back in the future for matching functionality.
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <ul className="space-y-2">
                ...
                <li className="flex gap-2">
                  ...
                  <span>Follow the guided prompts to help create meaningful conversation.</span>
                </li>
                <li className="flex gap-2">
                  <div className="h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center shrink-0 mt-0.5">
                    <span className="text-primary text-xs">3</span>
                  </div>
                  <span>If you feel uncomfortable at any time, you can end the session.</span>
                </li>
                <li className="flex gap-2">
                  <div className="h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center shrink-0 mt-0.5">
                    <span className="text-primary text-xs">4</span>
                  </div>
                  <span>Report any inappropriate behavior through our reporting system.</span>
                </li>
                <li className="flex gap-2">
                  <div className="h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center shrink-0 mt-0.5">
